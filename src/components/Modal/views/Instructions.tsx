...
const Instructions: FC<InstructionsProps> = ({
  ...
  return (
    <section className="bg-general-bg py-6 px-4 z-20 text-dark-gray grid place-items-center text-center border border-dark-gray absolute w-10/12  m-auto top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-md ">
